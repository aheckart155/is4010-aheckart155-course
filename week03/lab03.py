...
def generate_mad_lib(adjective, noun, verb):
    ...
    """
    story = f"In a dark mysterious world, the {adjective} {noun} suddenly {verb} through the building."
    
    return story


result = generate_mad_lib("giant", "marshmallow", "floated")
print(result)
...
def guessing_game():
    ...
    attempts = 0
    guess = 0
    print("Welcome to the Number Guessing Game! Please pick a number and I will tell you higher or lower.")
